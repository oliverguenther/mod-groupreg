<?php
    ...
    /// Print names of all the fields
        ...
        $myxls->write_string(0,4,get_string("groupreg","groupreg"));
    ...
    /// generate the data for the body of the spreadsheet
        ...
        if ($users) {
            foreach ($users as $option => $userid) {
                $option_text = groupreg_get_option_text($choice, $option);
    ...
    if ($download == "xls" && has_capability('mod/groupreg:downloadresponses', $context)) {
    ...
    // print text file
    if ($download == "txt" && has_capability('mod/groupreg:downloadresponses', $context)) {
        ...
        echo get_string("groupreg","groupreg"). "\n";
