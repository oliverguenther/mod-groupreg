<?php
    ...
    $PAGE->set_url('/mod/groupreg/index.php', array('id'=>$id));
    ...
    add_to_log($course->id, "groupreg", "view all", "index.php?id=$course->id", "");
    ...
    if (! $choices = get_all_instances_in_course("groupreg", $course)) {
